package pub.gll.retrofit.convert;
...
import pub.gll.retrofit.base.BaseModel;
import pub.gll.retrofit.log.LogUtil;
import pub.gll.retrofit.retrofit.ApiException;
...
final class MyGsonResponseBodyConverter<T> implements Converter<ResponseBody, T> {
    ...
    public T convert(ResponseBody value) throws IOException {
        ...
        if (re.getErrcode() !=200) {
            value.close();
            LogUtil.i("MyGsonResponseBodyConverter",Thread.currentThread()+"====");
//            Toast.makeText(FramApplication.getApplication().getApplicationContext(),"密码错误",Toast.LENGTH_SHORT).show();
            throw new ApiException(re.getErrcode(),"");
        }
